...
export const sampleProjects: Project[] = [
  ...
  // ── Real flagship audits (black-box, evidence-backed) ────────────────────────
  {
    ...
    featured: true,
    featuredOrder: 1,
    thumbnail: "https://raw.githubusercontent.com/Zainn09/portfolio-images/main/QA-PORTFOLIO-ASSETS/Sprint-01/01-fandiem/images/01_fandiem_desktop_home_hero_001.jpg",
    heroImage: "https://raw.githubusercontent.com/Zainn09/portfolio-images/main/QA-PORTFOLIO-ASSETS/Sprint-01/01-fandiem/images/01_fandiem_desktop_home_hero_001.jpg",
    gallery: [
      "https://raw.githubusercontent.com/Zainn09/portfolio-images/main/QA-PORTFOLIO-ASSETS/Sprint-01/01-fandiem/images/01_fandiem_desktop_collection_listing_001.jpg",
      "https://raw.githubusercontent.com/Zainn09/portfolio-images/main/QA-PORTFOLIO-ASSETS/Sprint-01/01-fandiem/images/01_fandiem_desktop_product_detail_001.jpg",
      "https://raw.githubusercontent.com/Zainn09/portfolio-images/main/QA-PORTFOLIO-ASSETS/Sprint-01/01-fandiem/images/01_fandiem_responsive_comparison_001.jpg",
      "https://raw.githubusercontent.com/Zainn09/portfolio-images/main/QA-PORTFOLIO-ASSETS/Sprint-01/01-fandiem/images/01_fandiem_qa_user_flow_sequence_001.jpg",
      "https://raw.githubusercontent.com/Zainn09/portfolio-images/main/QA-PORTFOLIO-ASSETS/Sprint-01/01-fandiem/images/01_fandiem_project_highlight_donation_journey_001.jpg",
    ],
    ...
    challenge: "Fandiem converts fandom into charitable donations through sweepstakes mechanics — donate, gain entries, win artist experiences. The audit had to verify the money boundary (donations to entries), time-bound sweep lifecycles, charity attribution, and a widget-heavy UI without source-code access.",
    ...
    rootCause: "Most findings trace to overlay management (chat, cookie consent, and PWA prompt competing for the same viewport corner) and content-binding gaps between listing cards and detail pages — typical of fast-moving campaign templates.",
    resolution: "Documented each finding with capture evidence, severity, and remediation guidance: overlay stacking rules, deterministic end-cutoff behavior with visible timezones, idempotent entry submits, and card-to-detail consistency checks.",
    outcome: "A prioritized, evidence-backed remediation backlog covering the money path, lifecycle timing, charity attribution, and mobile overlay states — plus a repeatable regression baseline for future campaign launches.",
    ...
    verification: [
      { label: "Functional", status: "verified" },
      { label: "UI/UX", status: "verified" },
      { label: "Responsive", status: "verified" },
      { label: "Content Integrity", status: "verified" },
      { label: "Entry Execution", status: "pending" },
      { label: "Accessibility", status: "pending" },
    ],
  ...
  },
  {
    ...
    featured: true,
    featuredOrder: 2,
    thumbnail: "https://raw.githubusercontent.com/Zainn09/portfolio-images/main/QA-PORTFOLIO-ASSETS/Sprint-01/03-kcaps/images/03_kcaps_desktop_home_hero_001.jpg",
    heroImage: "https://raw.githubusercontent.com/Zainn09/portfolio-images/main/QA-PORTFOLIO-ASSETS/Sprint-01/03-kcaps/images/03_kcaps_desktop_home_hero_001.jpg",
    gallery: [
      "https://raw.githubusercontent.com/Zainn09/portfolio-images/main/QA-PORTFOLIO-ASSETS/Sprint-01/03-kcaps/images/03_kcaps_desktop_collection_listing_001.jpg",
      "https://raw.githubusercontent.com/Zainn09/portfolio-images/main/QA-PORTFOLIO-ASSETS/Sprint-01/03-kcaps/images/03_kcaps_project_highlight_capsule_configurator_001.jpg",
      "https://raw.githubusercontent.com/Zainn09/portfolio-images/main/QA-PORTFOLIO-ASSETS/Sprint-01/03-kcaps/images/03_kcaps_desktop_product_detail_001.jpg",
      "https://raw.githubusercontent.com/Zainn09/portfolio-images/main/QA-PORTFOLIO-ASSETS/Sprint-01/03-kcaps/images/03_kcaps_responsive_comparison_001.jpg",
      "https://raw.githubusercontent.com/Zainn09/portfolio-images/main/QA-PORTFOLIO-ASSETS/Sprint-01/03-kcaps/images/03_kcaps_qa_user_flow_sequence_001.jpg",
    ],
    ...
    verification: [
      ...
      { label: "Responsive", status: "verified" },
      { label: "Content Integrity", status: "verified" },
      { label: "RFQ Execution", status: "pending" },
      { label: "Accessibility", status: "pending" },
    ],
  ...
  },
  {
    ...
    featured: true,
    featuredOrder: 3,
    thumbnail: "https://raw.githubusercontent.com/Zainn09/portfolio-images/main/QA-PORTFOLIO-ASSETS/Sprint-01/05-hershop/images/05_hershop_desktop_home_hero_001.jpg",
    heroImage: "https://raw.githubusercontent.com/Zainn09/portfolio-images/main/QA-PORTFOLIO-ASSETS/Sprint-01/05-hershop/images/05_hershop_desktop_home_hero_001.jpg",
    gallery: [
      "https://raw.githubusercontent.com/Zainn09/portfolio-images/main/QA-PORTFOLIO-ASSETS/Sprint-01/05-hershop/images/05_hershop_desktop_collection_listing_001.jpg",
      "https://raw.githubusercontent.com/Zainn09/portfolio-images/main/QA-PORTFOLIO-ASSETS/Sprint-01/05-hershop/images/05_hershop_desktop_product_detail_001.jpg",
      "https://raw.githubusercontent.com/Zainn09/portfolio-images/main/QA-PORTFOLIO-ASSETS/Sprint-01/05-hershop/images/05_hershop_project_highlight_bridal_editorial_merchandising_001.jpg",
      "https://raw.githubusercontent.com/Zainn09/portfolio-images/main/QA-PORTFOLIO-ASSETS/Sprint-01/05-hershop/images/05_hershop_responsive_comparison_001.jpg",
      "https://raw.githubusercontent.com/Zainn09/portfolio-images/main/QA-PORTFOLIO-ASSETS/Sprint-01/05-hershop/images/05_hershop_qa_user_flow_sequence_001.jpg",
    ],
    ...
    verification: [
      ...
      { label: "Responsive", status: "verified" },
      { label: "Content Integrity", status: "verified" },
      { label: "Checkout Execution", status: "pending" },
      { label: "Accessibility", status: "pending" },
    ],
